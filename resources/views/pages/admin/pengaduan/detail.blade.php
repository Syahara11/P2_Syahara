...
@section('content')
    <main class="main" id="main">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Detil Pengaduan</h1>
            <p class="mb-4">Detil pengaduan dari dari <span class="text-capitalize">{{ $item->name }}</span> pada
                ...
                <div class="card-body p-3">
                    ...
                    <p>Status :
                        @if ($item->status == 'Belum di Proses')
                            <span class="badge bg-danger text-white p-2">{{ $item->status }}</span>
            ...
            <div class="card shadow mb-4">
                <div class="card-body p-3">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-lg-4 mb-2">
                            <h5 class="mb-1 fw-bold">Keterangan</h5>
                            <p class="mb-0">{{ $item->description }}</p>
                        </div>
                        <div class="col-12 col-lg-4 mb-2">
                            <h5 class="fw-semibold mb-1 fw-bold">Tanggapan</h5>
                            <p class="mb-0">
                        ...
                        <div class="col-12 d-flex justify-content-end gap-2">
                            <a href="{{ url('admin/pengaduan/cetak', $item->id) }}" class="btn btn-danger">Ekspor Ke
                                PDF</a>
                            @if (empty($tangap->tanggapan))
                                <a href="{{ route('tanggapan.show', $item->id) }}" class="btn btn-primary">Berikan
                                    Tanggapan</a>
                            @else
                                <a href="{{ route('tanggapan.show', $item->id) }}" class="btn btn-primary">Edit
                                    Tanggapan</a>
                            @endif
                        </div>
                    </div>
                ...
                <div class="w-full overflow-x-auto">
                    @foreach ($item->details as $ite)
                        <div
                            ...
                            <h2>Nama : {{ $ite->name }}</h2>
                            <h2 class="mt-4">NIK : {{ $item->user_nik }}</h2>
